...
function setup() {
  ...
  /* ======== Start of 3 sliders that can be used to change tha canvas' background ======= */
  ...
  */
  ...
  resetDrawings = createButton('Reset Saved Drawings');
  resetDrawings.mousePressed(resetDraw);

  input = createInput('');

  savedDrawings = createElement('h3');
...
function draw() {
  ...
  savedDrawings.html('Go to your saved drawings' + ' ' + '--->');
  savedDrawings.position(930, 30);
